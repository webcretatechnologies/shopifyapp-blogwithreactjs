      ...
      >
        <Layout>
          <Layout.Section>
            <Banner>
              <p>
                Posts linked to a Shopify blog can be force-synced here. Posts
                marked <strong>Not Synced</strong> have not been published to
                Shopify yet.
              </p>
            </Banner>
          </Layout.Section>
              ...
              <Box padding="400">
                <BlockStack gap="300">
                  ...
                  {[
                    {
                      label: "Synced ✓",
                      desc: "Article is live on your Shopify blog",
                      tone: "success",
                    },
                    {
                      label: "Draft",
                      desc: "Saved in app but not published to Shopify",
                      tone: "info",
                    },
                    {
                      label: "Not Synced",
                      desc: "Post exists only in the app, no Shopify blog linked",
                      tone: "attention",
                    },
                    {
                      label: "Failed",
                      desc: "Last sync attempt failed — click Sync to retry",
                      tone: "critical",
                    },
                  ].map(({ label, desc, tone }) => (
