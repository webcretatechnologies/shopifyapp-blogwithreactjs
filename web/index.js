...
// Super Admin routes bypass Shopify shop validation and use JWT auth instead
app.use((req, res, next) => {
  // Skip Shopify validation for Super Admin console (/admin) and API routes (/admin-api)
  if (req.path.startsWith("/admin")) {
    return next();
  }
  // Apply Shopify validation for merchant app routes
